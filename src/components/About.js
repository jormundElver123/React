...
export default function About(props) {
  ...
  return (
    <div className="container my-2" style={{backgroundColor: props.mode === 'dark' ? '#212529' : 'white', color: props.mode === 'dark' ? 'white' : 'black'}}>
      <h2 style={AboutUsAlignment}>About Us</h2>
